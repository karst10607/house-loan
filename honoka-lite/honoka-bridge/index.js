...
const { saveToDisk, INBOX_DIR, DOCS_DIR, readRegistry, writeRegistry, resolveFolder, sanitizeFolderName, downloadImage } = require("./saver");
const { performCapture, ensurePlaywright } = require("./capture");
...
function handleRestart(req, res) {
  ...
  setTimeout(() => {
    ...
    const _telegramBot = getTelegramBot();
    if (_telegramBot) {
...
/**
 * Checks for yt-dlp and ffmpeg presence
 */
